...
const allData = [
  { date: '2023-05-20', region: '侯家沟数字化种植基地', severity: '轻旱', notes: '夏季降雨减少' },
  { date: '2023-06-15', region: '姜兴庄智慧引领种植基地', severity: '重旱', notes: '严重影响农作物' },
  { date: '2024-03-10', region: '李家寺数字化种植基地', severity: '中旱', notes: '春季干旱' },
  { date: '2024-08-05', region: '高家硷数字化种植基地', severity: '特旱', notes: '极端干旱' },
  { date: '2024-09-12', region: '冯渠数字化种植基地', severity: '中旱', notes: '连月无雨' },
  { date: '2024-10-20', region: '寺沟数字化种植基地', severity: '重旱', notes: '作物受损严重' },
  { date: '2025-01-15', region: '岳家岔数字化种植基地', severity: '轻旱', notes: '土壤湿度下降' },
  { date: '2025-02-18', region: '杨家沟数字化种植基地', severity: '中旱', notes: '降雨减少' },
  { date: '2025-04-10', region: '巩家沟数字化种植基地', severity: '重旱', notes: '水资源紧张' }
];
