      ...
      <el-row :gutter="20">
        ...
        <el-col :lg="4" :xs="24" style="">
          <el-card shadow="hover">
            <el-input v-model="deptName" placeholder="请输部门名称" prefix-icon="Search" clearable />
            <el-tree
              ref="deptTreeRef"
              class="mt-2"
              node-key="id"
        ...
        <el-col :lg="20" :xs="24">
          ...
          <el-card shadow="hover">
            ...
            >
              ...
              <vxe-column key="deptName" title="所在部门" align="center" field="deptName" />
