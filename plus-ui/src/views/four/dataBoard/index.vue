    ...
    <div class="dashboard-item top-right">
      <div class="title-container" style="justify-content: space-between">
        <div style="display: flex; align-items: center">
          ...
          <span class="title-text">作物长势监测</span>
        </div>
...
<script setup name="dataBoard" lang="ts">
    ...
    series: [
      {
        ...
        type: 'bar',
        barWidth: 12,
        data: data.map((item) => item.shallowWater / 100),
        itemStyle: {
          color: '#5470C6'
      ...
      },
      {
        ...
        type: 'bar',
        barWidth: 12,
        data: data.map((item) => item.middleWater / 100),
        itemStyle: {
          color: '#91CC75'
          // borderRadius: [4, 4, 0, 0]
        }
      },
      {
        ...
        type: 'bar',
        barWidth: 12,
        data: data.map((item) => item.deepWater / 100),
        itemStyle: {
          color: '#FAC858'
          // borderRadius: [4, 4, 0, 0]
        }
