...
export const constantRoutes: RouteRecordRaw[] = [
  ...
  {
    path: '/block/search/:traceCode?', // 添加可选参数
    component: () => import('@/views/process/block/search/index.vue'),
    hidden: true,
  ...
  },
  {
    ...
    children: [
      {
        path: '',
        component: () => import('@/views/process/disaster/map/index.vue'),
        name: 'DisasterSituationMap',
        meta: { title: '灾情地图可视化', icon: 'map', noCache: true }
      }
    ]
  },
  {
    ...
    children: [
      {
        path: '',
        component: () => import('@/views/process/disaster/raster/index.vue'),
        name: 'DisasterRaster',
        meta: { title: '灾害检测', icon: 'upload', noCache: true }
      }
    ]
  }
];
