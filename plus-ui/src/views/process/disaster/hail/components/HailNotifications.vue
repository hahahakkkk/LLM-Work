...
const settings = reactive({
  ...
  frequency: '每日',
  emails: ['example1@test.com', 'example2@test.com', 'example3@test.com', 'example4@test.com'],
  phones: ['13800000000', '13900000000', '13700000000', '13600000000'],
  alertMessage: '请注意，您所在区域即将发生冰雹天气，预计冰雹直径10-20mm，请做好防护措施。'
});
...
function resetSettings() {
  ...
  settings.emails = [];
  settings.phones = [];
  settings.alertMessage = '请注意，您所在区域即将发生冰雹天气，预计冰雹直径10-20mm，请做好防护措施。';
  newEmail.value = '';
  newPhone.value = '';
