    ...
    <template v-if="!loading">
      <div v-for="(result, index) in displayResults" :key="index" class="result-card">
        <div class="header-section">
          <h2 class="result-title">{{ result.base }}{{ selectedPlotLabel }}号预测结果</h2>
        ...
        <div class="conclusion-section">
          ...
          <div class="water-fertilizer-status">
            <h3 class="module-title">肥亏缺诊断结果</h3>
            <div class="indicators-grid">
              <!-- 突出显示区域 -->
              <div class="highlight-section">
                <div class="indicator-item">
                  <span class="indicator-label">缺肥等级：</span>
                  <el-tag :type="getFertilizerDeficitType(result.fertilizerDeficitLevel)" size="large" class="custom-tag">
          ...
          <div class="harvest-suggestion">
            <h3 class="module-title">补肥推荐方案</h3>
...
const getHarvestSuggestion = (result: DisplayResult) => {
  if (result.ratio >= 0.15)
    return '当前地块中度缺肥，谷子处于拔节期，参照每亩地10-12公斤高氮复合肥用量，及时补充土壤养分。施肥时大面积规则田块建议选择机械沟施，少量需补肥田块可人工穴施，提高耕作效率。施肥后若遇土壤干旱，及时补水，避开高温时间段。';
  return '当前地块中度缺肥，谷子处于拔节期，参照每亩地10-12公斤高氮复合肥用量，及时补充土壤养分。施肥时大面积规则田块建议选择机械沟施，少量需补肥田块可人工穴施，提高耕作效率。施肥后若遇土壤干旱，及时补水，避开高温时间段。';
};
