        ...
        <el-card shadow="hover">
          <el-form ref="queryFormRef" :model="queryParams" :inline="true">
            ...
            <!--<el-form-item label="灌溉地块" prop="landId" >
              <el-select v-model="queryParams.landId" placeholder="请选择灌溉地块" clearable>
    ...
    <el-dialog :title="dialog.title" v-model="dialog.visible" width="500px" append-to-body>
      <el-form ref="irrigationRecordsFormRef" :model="form" :rules="rules" label-width="120px">
        ...
        <!--<el-form-item label="灌溉地块" prop="landId" v-if=display1>
          <el-select v-model="form.landId" placeholder="请选择灌溉地块" clearable>
            <el-option v-for="dict in landDict"  :label="dict.label" :value="dict.value" />
          </el-select>
        </el-form-item>
...
<script setup name="IrrigationRecord" lang="ts">
...
} from '@/views/mz_base/api/irrigationRecords';
import { IrrigationRecordsVO, IrrigationRecordsQuery, IrrigationRecordsForm } from '@/views/mz_base/api/irrigationRecords/types';
import { landDictQuery, farmerDictQuery, farmerBaseDictQuery } from '@/views/mz_base/api/tableDict';
