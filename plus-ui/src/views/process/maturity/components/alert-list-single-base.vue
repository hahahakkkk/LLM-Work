...
const alertList = computed<AlertItem[]>(() => {
  return props.alerts && props.alerts.length > 0 ? props.alerts : [];
});
        ...
        <div class="alert-item-header">
          <div class="alert-item-title-wrapper">
            <div class="alert-item-title">
              {{ getPlotLabel(alert.field).slice(-6) }}号{{ alert.title }}
...
.alert-list-container {
  ...
  .alert-list {
    ...
    .alert-item-card {
      ...
      padding: 0.5vh;
      margin-bottom: 0.5vh;
      border: 0.1vh solid #ebeef5;
      border-radius: 0.2vh;

      &.alert-unhandled {
        border-right: 0.4vh solid #f56c6c;
      }

      &.alert-handled {
        border-right: 0.4vh solid #67c23a;
      }
      ...
      &:hover {
        box-shadow: 0 0.2vh 1.2vh 0 rgba(0, 0, 0, 0.2);
