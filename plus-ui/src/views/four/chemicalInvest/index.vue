...
<script setup name="ChemicalInvest" lang="ts">
import { globalHeaders } from '@/utils/request';
import { listChemicalBuy, getChemicalBuy, delChemicalBuy, addChemicalBuy, updateChemicalBuy } from '@/views/mz_base/api/chemicalBuy/index';
import { ChemicalBuyVO, ChemicalBuyQuery, ChemicalBuyForm } from '@/views/mz_base/api/chemicalBuy/types';
import { chemicalDictQuery, farmerBaseDictQuery, farmerDictQuery, farmerLandDictQuery } from '@/views/mz_base/api/tableDict';
import { useChemicalStore } from '@/views/mz_base/store/chemical';
