      ...
      <div v-for="(result, index) in displayResults" :key="index" class="result-card">
        ...
        <div class="conclusion-section">
          ...
          <div class="growth-metrics">
            <h3 class="module-title">长势监测结果</h3>
          ...
          <div class="water-fertilizer-status">
            <h3 class="module-title">水肥监测结果</h3>
            <div class="indicators-grid">
              <!-- 突出显示区域 -->
              <div class="highlight-section">
                <div class="indicator-item">
                  <span class="indicator-label">缺肥等级：</span>
                  <el-tag :type="getFertilizerDeficitType(result.fertilizerDeficitLevel)" size="large" class="custom-tag highlight-tag">
                    {{ result.fertilizerDeficitLevel }}
                  </el-tag>
                </div>
                <div class="indicator-item">
              ...
              <div class="other-indicators">
                <div class="indicator-row">
                  <div class="indicator-item">
                    ...
                    <el-tag size="large" class="custom-tag">{{ result.milletWaterTrait }}</el-tag>
                  </div>
                  <div class="indicator-item">
                ...
                <div class="indicator-row">
                  <div class="indicator-item">
                    ...
                    <el-tag :type="getSoilMoistureType(result.soilMoistureLevel)" size="large" class="custom-tag">
                      {{ result.soilMoistureLevel }}
                    </el-tag>
                  </div>
                </div>
                <div class="indicator-row">
          ...
          <div class="harvest-suggestion">
            <h3 class="module-title">水肥补给推荐</h3>
...
const getHarvestSuggestion = (result: DisplayResult) => {
  if (result.ratio >= 0.15)
    return '当前地块轻微缺水，尚处于可控状态，建议结合未来天气情况酌情考虑补水：若未来一周内有降雨天，则保持监测即可。若无降雨天气，适当引水穴灌，且需注意禁止在正午高温时段灌水，避免汽烫伤苗。\n 当前地块中度缺肥，谷子处于拔节期，参照每亩地10-12公斤高氮复合肥用量，及时补充土壤养分。施肥时大面积规则田块建议选择机械沟施，少量需补肥田块可人工穴施，提高耕作效率。施肥后若遇土壤干旱，及时补水，避开高温时间段。\n';
  return '当前地块轻微缺水，尚处于可控状态，建议结合未来天气情况酌情考虑补水：若未来一周内有降雨天，则保持监测即可。若无降雨天气，适当引水穴灌，且需注意禁止在正午高温时段灌水，避免汽烫伤苗。\n 当前地块中度缺肥，谷子处于拔节期，参照每亩地10-12公斤高氮复合肥用量，及时补充土壤养分。施肥时大面积规则田块建议选择机械沟施，少量需补肥田块可人工穴施，提高耕作效率。施肥后若遇土壤干旱，及时补水，避开高温时间段。\n';
};
