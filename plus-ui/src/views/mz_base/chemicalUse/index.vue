...
<script setup name="ChemicalUse" lang="ts">
import { globalHeaders } from '@/utils/request';
import { listChemicalUse, getChemicalUse, delChemicalUse, addChemicalUse, updateChemicalUse } from '../api/chemicalUse/index';
import { ChemicalUseVO, ChemicalUseQuery, ChemicalUseForm } from '../api/chemicalUse/types';
import { chemicalDictQuery, landDictQuery, farmerDictQuery, farmerBaseDictQuery } from '../api/tableDict';
