  ...
  <div class="p-2">
    ...
    <el-card shadow="never">
      ...
      <el-table v-loading="loading" :data="fertilizerUseList" @selection-change="handleSelectionChange">
        ...
        <el-table-column v-if="columns[0].visible" key="useId" label="使用记录" align="center" prop="useId" />
...
<script setup name="FertilizerUse" lang="ts">
import { listFertilizerUse, getFertilizerUse, delFertilizerUse, addFertilizerUse, updateFertilizerUse } from '../api/fertilizerUse/index';
import { FertilizerUseVO, FertilizerUseQuery, FertilizerUseForm } from '../api/fertilizerUse/types';
import { globalHeaders } from '@/utils/request';
import { fertilizerDictQuery, landDictQuery, farmerDictQuery, farmerBaseDictQuery } from '../api/tableDict';
